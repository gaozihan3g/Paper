...
\label{sec:5}
%platform
We have implemented PotteryVR using the game engine Unity3D\cite{website:unity} and VR system HTC Vive\cite{website:vive}. PotteryVR can run on Windows 10 platform.

%figs
In order to get performance statistics of the mesh generator, we tested PotteryVR on a PC () to generate 4 models with different resolutions.
