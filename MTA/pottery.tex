...
\label{sec:3}
EasyPot is an interactive modeling system based on handheld devices and a head-mounted display. 
...
\subsection{Workflow}
\label{sec:3.2}
In real life, the pottery creation process on a pottery wheel is called "throwing", where a ball of clay is placed in the centre of a turntable wheel-head, and shaped by a potter.
