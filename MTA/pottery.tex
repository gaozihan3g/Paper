...
\subsection{User Study 2: RealPot vs other virtual pottery systems}
\label{sec:study3}
%GOAL
To investigate the usability of RealPot, we compare RealPot with other virtual pottery systems.

We used DigiClay, a virtual pottery system based on barehand interaction.
