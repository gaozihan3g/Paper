...
Unlike general purpose CAD tools (Maya \cite{website:maya}, 3ds Max \cite{website:3dmax}, etc.) with powerful toolsets and rich features, virtual pottery systems are specifically designed, usually allows rotational symmetric deformation.

// more virtual pottery system intro
...
\cite{koutsoudis2009qp,kumar2011wheel,ramani2015gesture,murugappan2013handy,han2014virtual}

// however, limitation

// low interaction fidelity - not close to real world, some are overlooked
...
When a user starts to use RealPot, a realistic clay mesh is automatically generated with Perlin noise (Figure \ref{fig:workflow}a, Section \ref{sec:3.2}). 
