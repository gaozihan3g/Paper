...
EasyPot is designed as a workshop built in a virtual environment. In our implementation, we use HTC Vive VR system \cite{website:vive}, which includes a head-mounted display and two hand-held controllers to track user head orientation and bimanual movement (Figure \ref{fig:ui}).
